...
class PhaseTwoScenarioIntegrationTest {
    private static final String RUN_ID = "phase2-integration-test";
    ...
    void phaseOneAndAllSixteenPhaseTwoVariantsPassWithValidatedEvidence() {
