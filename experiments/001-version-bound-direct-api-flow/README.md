...
Fas 1-kombinationer och 16 Fas 2-kombinationer; den är inte
...
Fas 1–2-integrationstester och skapar `target/experiment-001-cli.jar`.
Integrationstestet kör alla 20 implementerade kombinationer och validerar ett
...
```bash
export RUN_ID=phase2-verification
...
Samla bara slutlig evidens när samtliga 20 resultat är `pass`.
...
`target/experiment-001/evidence/$RUN_ID/`. Manifestet omfattar båda faserna,
